        ...
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <img src="{{ asset('img/logo.png') }}" style="width:3vh;height:3vh;margin-top:-1vh;">CODER
                   </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                border-style: solid;border-color: white; border-top-width: 0px; 
                border-left-width: 0px; border-right-width: 0px;
                border-bottom-width: thin; ">{{ __('Register') }}</div>

                <div class="card-body"style=" background-color: #222222;
                border-style: solid;border-color: azure; border-top-width: 0px; 
                border-left-width: 0px; border-right-width: 0px;
